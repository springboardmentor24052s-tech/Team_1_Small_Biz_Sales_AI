...
class Permissions:
    ...
    DASHBOARD_ANOMALIES_VIEW = "dashboard.anomalies.view"
    DASHBOARD_ANOMALIES_MANAGE = "dashboard.anomalies.manage"
    ...
    ANOMALIES_MANAGE = "anomalies.manage"
...
ROLE_DEFINITIONS: dict[RoleCode, dict[str, object]] = {
    RoleCode.BUSINESS_OWNER: {
        ...
        "permissions": {
            ...
            Permissions.DASHBOARD_ANOMALIES_VIEW,
