...
def dashboard_access(user: CurrentUser):
    ...
    if Permissions.INVOICES_MANAGE in permissions:
        modules.append(module("invoices", "manage", "view", "create", "payments", "export"))
    elif Permissions.INVOICES_READ in permissions:
        modules.append(module("invoices", "view", "view", "export"))

    if Permissions.ANOMALIES_MANAGE in permissions:
        modules.append(module("anomalies", "manage", "view", "resolve", "tune"))
    elif Permissions.ANOMALIES_READ in permissions:
        modules.append(module("anomalies", "view", "view"))

    if Permissions.MODELS_MANAGE in permissions:
        modules.append(module("ai_config", "manage", "view", "tune", "retrain"))
