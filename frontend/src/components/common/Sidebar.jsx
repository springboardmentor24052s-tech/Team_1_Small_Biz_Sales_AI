...
export const Sidebar = ({ activeTab, setActiveTab, isCollapsed, setIsCollapsed }) => {
  ...
  const navItems = [
    ...
    { id: 'recommendations', label: 'AI Recommender', icon: Sparkles, badge: 'AI', badgeColor: 'bg-indigo-500/20 text-indigo-300' },
    { id: 'churn', label: 'Churn Analytics', icon: Users, badge: 'Risk', badgeColor: 'bg-rose-500/20 text-rose-300' },
    { id: 'anomalies', label: 'Anomaly Alerts', icon: Activity, badge: 'ML', badgeColor: 'bg-amber-500/20 text-amber-300' },
